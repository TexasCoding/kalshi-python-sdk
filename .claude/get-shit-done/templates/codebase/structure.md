...
- Usage: Reference from command with `@/Users/jeffreywest/Code/Python/kalshi-python-sdk/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/jeffreywest/Code/Python/kalshi-python-sdk/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/jeffreywest/Code/Python/kalshi-python-sdk/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
