...
- **Global scope**: `/Users/jeffreywest/Code/Python/kalshi-python-sdk/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/jeffreywest/Code/Python/kalshi-python-sdk/.claude/notes/`)
...
2. Glob `/Users/jeffreywest/Code/Python/kalshi-python-sdk/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/jeffreywest/Code/Python/kalshi-python-sdk/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/jeffreywest/Code/Python/kalshi-python-sdk/.claude/notes/` — works in any directory
