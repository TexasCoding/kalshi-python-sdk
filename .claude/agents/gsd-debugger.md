...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/jeffreywest/Code/Python/kalshi-python-sdk/.claude
                  → checks /Users/jeffreywest/Code/Python/kalshi-python-sdk/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/jeffreywest/Code/Python/kalshi-python-sdk/.claude/get-shit-done
                  → writes to /Users/jeffreywest/Code/Python/kalshi-python-sdk/.claude/get-shit-done/hooks/
...
@/Users/jeffreywest/Code/Python/kalshi-python-sdk/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/jeffreywest/Code/Python/kalshi-python-sdk/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/jeffreywest/Code/Python/kalshi-python-sdk/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/jeffreywest/Code/Python/kalshi-python-sdk/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/jeffreywest/Code/Python/kalshi-python-sdk/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
