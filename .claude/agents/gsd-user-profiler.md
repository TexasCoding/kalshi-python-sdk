...
<reference>
@/Users/jeffreywest/Code/Python/kalshi-python-sdk/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/jeffreywest/Code/Python/kalshi-python-sdk/.claude/get-shit-done/references/user-profiling.md` to load:
